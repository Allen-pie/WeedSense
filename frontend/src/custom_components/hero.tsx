...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden border-b border-outline z-20 mb-20">
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-secondary-foreground text-lg md:text-xl max-w-2xl mx-auto mb-8">
            Our AI-powered tool precisely identifies and segments weeds in
            agricultural images, helping you optimize crop management and reduce
            herbicide usage.
          </p>
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
          <div className="animate-bounce  p-2 rounded-full border border-outline">
            <svg
